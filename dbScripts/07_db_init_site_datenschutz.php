...
try {
    ...
    echo "<h1>Initialisierung: Datenschutz (site_pages)</h1>";

    $result = site_page_seed_legal_page($db, 'datenschutz', false);
    if ($result === 'inserted') {
        echo "✅ datenschutz angelegt (Platzhalter-Daten).<br>";
    } elseif ($result === 'replaced') {
        echo "✅ datenschutz auf Platzhalter-Inhalt zurückgesetzt.<br>";
    } else {
        echo "ℹ️ datenschutz unverändert.<br>";
    }
} catch (Exception $e) {
