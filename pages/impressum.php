<section class="card" aria-label="Impressum">
    <h1>Impressum</h1>

    <h2>Diensteanbieter</h2>
    <p>
        <strong>Name:</strong> Sascha Fähling<br>
        <strong>Anschrift:</strong> Humboldtstraße 25, Monheim am Rhein, Deutschland
    </p>

    <h2>Kontakt</h2>
    <p>
        <strong>E-Mail:</strong> <a href="mailto:sascha.faehling@protonmail.com">sascha.faehling@protonmail.com</a>
    </p>
